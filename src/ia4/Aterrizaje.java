...
public class Aterrizaje extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelFondo2 = new ia4.PanelFondo();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setBackground(new java.awt.Color(215, 154, 94));
        ...
        panelFondo2.setBackground(new java.awt.Color(142, 179, 253));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aterrizaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Aterrizaje().setVisible(true);
            }
        });
    }
    ...
    private ia4.PanelFondo panelFondo2;
